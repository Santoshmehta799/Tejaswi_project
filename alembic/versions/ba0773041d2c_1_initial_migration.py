...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('STICKER_GUYS', 'DISPATCH_GUYS', name='userrole'), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_users_id'), 'users', ['id'], unique=False)
    op.create_index(op.f('ix_users_username'), 'users', ['username'], unique=True)
    op.create_table('stickergenerator',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.CheckConstraint("trading_name IN ('bharat', 'green')", name='check_trading_name_valid'),
    ...
    op.create_index(op.f('ix_stickergenerator_id'), 'stickergenerator', ['id'], unique=False)
    op.create_index(op.f('ix_stickergenerator_product_number'), 'stickergenerator', ['product_number'], unique=True)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_stickergenerator_product_number'), table_name='stickergenerator')
